...
| **敘獎登錄** | 登錄敘獎的發文日期、發文人員、事由與敘獎人員，可連續輸入並在下方即時預覽；敘獎人員可點右側常用人員名條（依歷來敘獎次數自動前移）或直接輸入姓名，名單外姓名也能填；簽收單列印可一併產生敘獎簽收表 |
| **罰單登錄** | 建置中，將於後續版本提供 |
...
> - **自助取號模式**：承辦人自己上系統陳報、先取得文號（暫不填發文資訊）；到了陳報日，送文者再到「簽收單列印」頁按一次**「結算發文」**，勾選要發的案件、補上發文日期與人員，即可直接印出簽收表；敘獎登錄也適用此模式。適合承辦人各自輸入、送文者集中發文的所內。
