...
| **敘獎登錄** | 登錄敘獎的事由與敘獎人員，可連續輸入並在下方即時預覽；敘獎人員可點右側常用人員名條（依歷來敘獎次數自動前移）、下拉選取或直接輸入姓名，名單外姓名也能填。發文日期與發文人員改在「敘獎發文」頁登記 |
| **敘獎發文** | 由發文者輸入敘獎登錄的編號，逐筆加入清單後批次登記發文日期與發文人員（比照交辦單發文）；被退件的可再次輸入覆蓋發文。簽收單列印可一併產生敘獎簽收表 |
...
> - **自助取號模式**：承辦人自己上系統陳報、先取得文號（暫不填發文資訊）；到了陳報日，送文者再到「簽收單列印」頁按一次**「結算發文」**，勾選要發的案件、補上發文日期與人員，即可直接印出簽收表。適合承辦人各自輸入、送文者集中發文的所內。（此模式適用刑案／一般陳報與罰單登錄；敘獎另走「敘獎登錄→敘獎發文」兩頁流程，與此模式無關。）
...
>
> ⚠️ 敘獎發文、簽收單列印、檔案歸檔、備份還原與跨年度重置只有主程式有。
