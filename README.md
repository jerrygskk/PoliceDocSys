...
| **簽收單列印** | 依發文日期產生簽收表（含交辦／刑案／一般／敘獎），預覽後列印或存成 PDF |
...
> - **自助取號模式**：承辦人自己上系統陳報、先取得文號（暫不填發文資訊）；到了陳報日，送文者再到「簽收單列印」頁按一次**「結算發文」**，勾選要發的案件、補上發文日期與人員，即可直接印出簽收表。適合承辦人各自輸入、送文者集中發文的所內。（此模式只適用刑案／一般陳報；敘獎另走「敘獎登錄→敘獎發文」兩頁流程，與此模式無關。）
