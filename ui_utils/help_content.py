...
HELP_PAGES = {
    ...
    3: [
        ...
        ("sec", "操作流程", [
            ("ol", [
                "送文者輸入模式須先選<b>發文日期</b>（預設今天）與<b>發文人員</b>；自助取號模式兩欄反灰不必填。",
                "輸入<b>敘獎事由</b>。",
        ...
        ("hint", "若管理者將<b>敘獎登錄</b>設為<b>自助取號模式</b>，發文日期與發文人員兩欄反灰不必填，"
    ...
    8: [
        ...
        ("sec", "系統設定", [
            ...
            ("ul", [
                ...
                "<b>自助取號模式</b>：承辦人自行陳報先取文號（暫不填發文資訊），送文者於陳報日到「簽收單列印」頁按「結算發文」統一補齊並印簽收表。自助取號模式影響刑案與一般陳報，以及敘獎登錄與罰單登錄；四項可<b>分別</b>設定模式。敘獎設為自助取號時，發文日期與發文人員兩欄反灰；罰單設為自助取號時，發文人員欄反灰，發文資訊皆改由結算補齊。",
...
QUICKSTART = {
    0: ("一般使用者顯示業務登錄、簽收單列印、資料庫瀏覽與資料庫設定；"
        ...
        "發文日期與今天差距較大時（早於今天，或晚於今天 10 天以上）會跳一次確認。日期欄已停用滾輪、方向鍵與點擊步進，改日期請直接輸入數字或用月曆挑。"),
    ...
    3: ("登錄敘獎事由與敘獎人員，可連續輸入。",
        ["送文者輸入模式先選發文日期與發文人員；自助取號模式兩欄反灰不必填。",
         "輸入敘獎事由。",
         "點候選人員名條或輸入姓名；多人以逗號分隔，名單外姓名也可直接輸入。",
         "按「確認登錄」，系統自動記錄今天為登錄日期，並在本次預覽確認結果。"],
        ["候選人員依「資料庫設定 → 人員」的排序顯示。",
         "發文日期與今天差距較大時（早於今天，或晚於今天 10 天以上）會跳一次確認。日期欄已停用滾輪、方向鍵與點擊步進，改日期請直接輸入數字或用月曆挑。",
         "自助取號模式下新登錄資料一律為未發文，發文資訊由送文者日後於「簽收單列印」頁結算補齊。"]),
    4: ("登錄舉發罰單，一張罰單一位開立人員；可單獨設定送文者輸入模式或自助取號模式。",
    ...
    5: ("依發文日期彙整當天所有發文，整理成簽收表。",
        ...
        "刑案陳報、一般陳報、敘獎登錄或罰單登錄任一功能設為自助取號模式時，本頁上方多出「結算發文」：單一表格列出所有未發文的刑案／一般／敘獎／罰單案件，包含切換模式前殘留的未發文公文。四項皆為送文者輸入模式但仍有未發文殘留資料時，入口也會顯示，供補齊殘留案件；全部結算完成後即隱藏。可用類型標籤與關鍵字過濾、表頭全選（僅作用於顯示中列），選發文日期（預設今天、可回填）與送文者後補齊發文資訊並自動產生簽收表。"
        "結算的發文日期同樣有上述確認提示。"),
    ...
    8: ("維護人員／部門／案類等基礎資料、系統設定與跨年度重置。本頁供管理者使用；歸檔管理僅能變更密碼與設定歸檔資料夾。",
        ...
        ["自助取號模式影響刑案與一般陳報，以及敘獎登錄與罰單登錄；四項可分別設定。",
