...
HELP_PAGES = {
    ...
    3: [
        ("lead", "登錄敘獎事由與敘獎人員，可連續輸入並在下方預覽本次登錄。"),
        ("sec", "操作流程", [
            ("ol", [
                "輸入<b>敘獎事由</b>。",
    ...
    4: [
        ("lead", "輸入敘獎編號建立待發清單，再批次填入發文日期與發文人員。"),
        ("sec", "操作流程", [
            ("ol", [
    ...
    5: [
        ("lead", "登錄舉發罰單，一張罰單一位開立人員；可由管理者在「系統設定 → 陳報模式」"
                 "單獨設定為<b>送文者輸入模式</b>或<b>自助取號模式</b>。"),
        ("sec", "操作流程", [
            ("ol", [
                "送文者輸入模式須先選<b>發文者</b>；自助取號模式此欄反灰不必填。",
        ...
        ("sec", "清空與修改", [
            ("ul", [
                "按<b>「清空」</b>只清空<b>開立人員</b>欄，發文者與罰單編號不動。",
        ...
        ("hint", "若管理者將<b>罰單登錄</b>設為<b>自助取號模式</b>，發文者欄反灰不必填，"
    ...
    6: [
        ("lead", "依<b>發文日期</b>把當天所有發文（交辦／刑案／一般／罰單／敘獎）整理成簽收表，供列印或存檔。敘獎資料以一個事由一列呈現。"),
        ("sec", "操作流程", [
            ("ol", [
                "選<b>發文日期</b>（預設今天）。",
    ...
    7: [
        ...
        ("sec", "罰單資料", [
            ("p", "可用登錄日期、發文日期、發文者、開立人員或罰單編號搜尋。點「編號」開修改視窗，"
                  "<b>僅管理者</b>可修改（含發文日期／發文者）與刪除；一般使用者、歸檔管理僅能檢視。"),
        ]),
        ("sec", "敘獎資料", [
    ...
    9: [
        ...
        ("sec", "系統設定", [
            ...
            ("ul", [
                ...
                "<b>自助取號模式</b>：承辦人自行陳報先取文號（暫不填發文資訊），送文者於陳報日到「簽收單列印」頁按「結算發文」統一補齊並印簽收表。自助取號模式影響刑案與一般陳報，以及罰單登錄；三項可<b>分別</b>設定模式。罰單設為自助取號時，發文者欄反灰、發文資訊改由結算補齊。",
...
HELP_TIPS = {
    ...
    5: {
        ...
        "ticket_clear_issuer":   "清空開立人員欄，發文者與罰單編號不動",
