...
#   0 交辦單發文 / 1 交辦單收文 / 2 公文陳報 / 3 敘獎登錄 / 4 敘獎發文
...
HELP_PAGES = {
    ...
    5: [
        ...
        ("sec", "結算發文（僅自助取號模式）", [
            ...
            ("ol", [
                "彈出視窗以單一表格列出所有<b>未發文</b>的刑案／一般案件（預設全勾）。敘獎請至「敘獎發文」頁處理。",
    ...
    8: [
        ...
        ("sec", "系統設定", [
            ...
            ("ul", [
                ...
                "<b>自助取號模式</b>：承辦人自行陳報先取文號（暫不填發文資訊），送文者於陳報日到「簽收單列印」頁按「結算發文」統一補齊並印簽收表。自助取號模式只影響刑案與一般陳報；<b>敘獎登錄與敘獎發文不受陳報模式影響</b>，請分別於對應頁面操作。",
                "儲存後立即生效；跨年度重置不清除。",
            ]),
        ]),
        ("sec", "資源回收筒（僅管理者）", [
...
QUICKSTART = {
    ...
    5: ("依發文日期彙整當天所有發文，整理成簽收表。",
        ...
        "自助取號模式下本頁上方多出「結算發文」：單一表格列出未發文的刑案／一般案件，可用類型標籤與關鍵字過濾、表頭全選（僅作用於顯示中列），選送文者後補齊發文資訊並自動產生簽收表；敘獎請至「敘獎發文」頁處理。"),
