    ...
    9: [
        ...
        ("sec", "系統設定", [
            ...
            ("ul", [
                ...
                "<b>自助取號模式</b>：承辦人自行陳報先取文號（暫不填發文資訊），送文者於陳報日到「簽收單列印」頁按「結算發文」統一補齊並印簽收表。刑案陳報、一般陳報與<b>罰單登錄</b>可<b>分別</b>設定模式；罰單設為自助取號時，發文者欄反灰、發文資訊改由結算補齊。",
                "交辦單與敘獎不提供此選項，因為必須由承辦人完成交辦事項、由敘獎人確認敘獎內容後，該筆資料才算被認可。",
